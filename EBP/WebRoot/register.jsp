  ...
  <body>
    	 <div id="login_dialog" class="panel panel-success">
            ...
            <div style="background-color:#ffffff;margin:10px;" class="panel-body">
                ...
                <form action='<c:url value="user/Register"/>' method='POST' onsubmit="return check()">                
                    <ul class="reg-box">                 
                        <li>
                            <label for="">账    号</label><input type="text" name="username" value="${param.username}" onBlur="textBlur(this)" onFocus="textFocus(this)" placeholder="请输入您的账号" class="account" maxlength="20" style="color:#999;"/><br>
	                            <p id="errorusername">
                        ...
                        <li>
                            <label for="">密    码</label><input type="password"  name="password" value="${param.password}" onBlur="textBlur(this)" onFocus="textFocus(this)" placeholder="请输入密码" style="color:#999;"/><br>
                            	<p id="errorpassword">
		                            <font color='red' size="-1"><i>
					                    <s:fielderror>
                        ...
                        <li>
                            <label for="">确认密码</label><input type="password"  name="password2" value="${param.password2}" onBlur="textBlur(this)" onFocus="textFocus(this)" placeholder="请确认密码" style="color:#999;"/><br>
                        ...
                        <li>
                            <label for="">验证码</label><input type="text" name="verifyCode" class="sradd photokey" onBlur="textBlur(this)" onFocus="textFocus(this)" placeholder="请输入验证码" style="color:#999;"/><span class="add phoKey"><img src="servlet/RandomImageServlet.view" onclick="this.src='servlet/RandomImageServlet.view?'+Math.random()"></span><br>
                            	<p id="errorvalidate">
		                            <font color='red' size="-1"><i>
					                   <s:fielderror>
                    ...
                    <div class="sub">
                        <input type="submit" class="loin_btn" value="立即注册" />
                    </div>                  
                </form>
            </div>
